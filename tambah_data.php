...
<select name="id_kategori" id="id_kategori" class="form-control" required>
    ...
    <?php endforeach; ?>
                    ...
                    <div class="mb-3">
                        ...
                        <input type="text" class="form-control" name="genre" id="genre" placeholder="Genre" autocomplete="off">
                    </div>
                    <div class="mb-3">
                    ...
                    <div class="mb-3">
                        ...
                        <input type="file" class="form-control" name="gambar" id="gambar" placeholder="Gambar" autocomplete="off">
                    </div>
                    <div class="mb-3">
